                ...
                <div class="flex flex-col w-full p-8 text-gray-800 bg-white shadow-lg pin-r pin-y md:w-4/5 lg:w-4/5">
                    <div class="flex-1">
                        <table class="w-full text-sm lg:text-base" cellspacing="0">
                            <thead>
                                <tr class="h-12 uppercase bg-slate-200">
                            ...
                            <tbody>
                                <tr>
                                    <td class="hidden pb-4 md:table-cell">
                                        <a href="#">
                                            <img src={consultation} class="w-20 rounded" alt="Thumbnail" />
                                        </a>
                                    </td>
                                    <td>
                                        <a href="#">
                                            <p class="mb-2 md:ml-4">Consultation fee 3000
                                                <br />
                                                Appoinment:
                                                Date:December 24,2022 <br />
                                                Time:10:00 am <br />
                                                Service:Session</p>
                        ...
                        <div class="my-4 mt-6 -mx-2 lg:flex">
                            <div class="lg:px-2 lg:w-1/2">
                                <div class="p-4 bg-gray-100 rounded-full">
                                    <h1 class="ml-2 font-bold uppercase">Coupon Discount</h1>
                                </div>
                                <div class="p-4">
                                    <p class="mb-4 italic">Enter your coupon code if you have one</p>
                                    <div class="justify-center md:flex">
                                        <form action="" method="POST">
                                            <div class="flex items-center w-full h-13 pl-3 bg-white bg-gray-100 border rounded-full">
                                                <input type="coupon" name="code" id="coupon" placeholder="Coupon code" value=""
                                                    class="w-full bg-gray-100 outline-none appearance-none focus:outline-none active:outline-none" />
                                                <button type="submit" class="text-sm flex items-center px-3 py-1 text-white bg-gray-800 rounded-full outline-none md:px-4 hover:bg-gray-700 focus:outline-none active:outline-none" style={{ backgroundColor: "#11b24c" }}>
                            ...
                            <div class="lg:px-2 lg:w-1/2">
                                ...
                                <div class="p-4">
                                    ...
                                    <a href="#">
                                        <button class="flex justify-center w-full px-10 py-3 mt-6 font-medium text-white uppercase bg-gray-800 rounded-full shadow item-center hover:bg-gray-700 focus:shadow-outline focus:outline-none" style={{ backgroundColor: "#11b24c" }}>
