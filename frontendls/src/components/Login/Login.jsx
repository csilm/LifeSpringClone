                ...
                <div>
                    ...
                    <div>
                        <form className='mt-10'>
                            ...
                            <div class="mb-4">
                                <label for="email" className="block mb-2  font-medium text-white dark:text-gray-300 text-left text-md">Email</label>
                        ...
                        <a href={'/'} className='text-sm text-center text-white mt-2'>Forgot your password ?</a>
