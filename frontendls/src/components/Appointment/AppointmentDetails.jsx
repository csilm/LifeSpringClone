        ...
        <div>
            ...
            <div className='flex gap-3 mx-10 min-h-full mt-10  justify-center'>
                <div className="mb-4">
                    ...
                    <input className="shadow appearance-none border-transparent bg-slate-200 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-green-500 " id="username" type="text" />
                </div>
                <div className="mb-4">
                    <label className="block text-gray-700 text-sm font-bold mb-2" style={{ color: "#11b24c" }} for="username">
                        Phone
            ...
            <div>
                ...
                <div className='flex gap-4 justify-center'>
                    ...
                    <Link to={"/orders"}>
                        <button className=" font-bold px-5 py-2  mb-10 rounded text-white" style={{ backgroundColor: "#11b24c" }}>Next</button>
                    </Link>
                </div>
