            ...
            <div className='mx-20'>
                <div className='grid grid-cols-4 gap-8'>
                    ...
                    <div className="">
                        <div class="box hover:scale-105 ease-in-out duration-1000">
                            ...
                            <div class="video-container">
                                ...
                                <p className='font-bold text-gray-400 text-xl'>প্রেসার বাড়লে যা করবেন</p>
                    </div>
                    </a>    
                    </Link>
                    ...
                    <div className="">
                        <div class="box hover:scale-105 ease-in-out duration-1000">
                            ...
                            <div class="video-container">
                                ...
                                <p className='font-bold text-gray-400 text-xl'>মেয়েদের অতিরিক্ত সাদা স্রাব</p>
                    </div>
                    </a>    
                    </Link>
                    ...
                    <div className="">
                        <div class="box hover:scale-105 ease-in-out duration-1000">
                            ...
                            <div class="video-container">
                                ...
                                <p className='font-bold text-gray-400 text-xl'>বিয়ের পরেও তাকে মনে পড়ে</p>
                    </div>
                    </a>
                    </Link>
                    ...
                    <div className="">
                        ...
                        <p className='font-bold text-gray-400 text-xl'>অভিভাবক হিসেবে করণীয়</p>
                    </div>
                    </Link>
