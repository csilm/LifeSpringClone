    ...
    <div>
      ...
      <div className=' w-full h-auto flex flex-col justify-center items-center flex-wrap'>
          ...
          <li className="dropdown inline px-4 text-slate-500 hover:text-blue-700 cursor-pointer font-semibold text-base tracking-wide">
            ...
            <div className="dropdown-menu z-10 absolute hidden h-auto  pt-4">
              <ul className="block w-[21rem] sty bg-white px-10 shadow-lg rounded-sm py-2 justify-start items-start">
                ...
                <li onClick={() => { setactive('Psychiatrist') }} className=" py-2.5"><a href='#prof' className="block text-sm text-gray-500 font-bold hover:text-green-600 cursor-pointer">Psychiatris</a></li>
                <li onClick={() => { setactive('Psychologist') }} className=" py-2.5"><a href='psy' className="block text-sm text-gray-500 font-bold hover:text-green-600 cursor-pointer">Psychologist</a></li>
                <li onClick={() => { setactive('Counselor') }} className=" py-2.5"><a href='#prof' className="block text-sm text-gray-500 font-bold hover:text-green-600 cursor-pointer">Counselor</a></li>
                <li onClick={() => { setactive('Child') }} className=" py-2.5"><a href='#prof' className="block text-sm text-gray-500 font-bold hover:text-green-600 cursor-pointer">Child and Adolescent</a></li>
                <li onClick={() => { setactive('Dermatologist') }} className=" py-2.5"><a href='#prof' className="block text-sm text-gray-500 font-bold hover:text-green-600 cursor-pointer">Dermatologist</a></li>
                <li onClick={() => { setactive('Sexual') }} className=" py-2.5"><a href='#prof' className="block text-sm text-gray-500 font-bold hover:text-green-600 cursor-pointer">Sexual Health</a></li>
                <li onClick={() => { setactive('Gynecologist') }} className=" py-2.5"><a href='#prof' className="block text-sm text-gray-500 font-bold hover:text-green-600 cursor-pointer">Gynechologist</a></li>
                <li onClick={() => { setactive('Internal') }} className=" py-2.5"><a href='#prof' className="block text-sm text-gray-500 font-bold hover:text-green-600 cursor-pointer">Internal Medicine</a></li>
                <li onClick={() => { setactive('Therapist') }} className=" py-2.5"><a href='#prof' className="block text-sm text-gray-500 font-bold hover:text-green-600 cursor-pointer">Development Therapist</a></li>
                <li onClick={() => { setactive('ENT') }} className=" py-2.5"><a href='#prof' className="block text-sm text-gray-500 font-bold hover:text-green-600 cursor-pointer">ENT</a></li>
                <li onClick={() => { setactive() }} className=" py-2.5"><a href='#prof' className="block text-sm text-gray-500 font-bold hover:text-green-600 cursor-pointer">Nutritionist</a></li>
                <li onClick={() => { setactive() }} className=" py-2.5"><a href='#prof' className="block text-sm text-gray-500 font-bold hover:text-green-600 cursor-pointer">Paediatrics</a></li>
              </ul>
            </div>
          </li>
        </div>
        <div className='w-full h-auto p-8 flex flex-row flex-wrap justify-center items-center lg:justify-start lg:items-start lg:pl-14'>
          {active === 'ALL' && Info.map((items) => { return <Card key={items.id} img={items.img} prof={items.prof} name={items.name} degree={items.degree} id={items.id} /> })}
          {active === 'Child' && Info.map((items) => {
            if (items.prof === 'CHILD-ADOLESCENT-PSYCHIATRIST') {
              return <Card key={items.id} img={items.img} prof={items.prof} name={items.name} degree={items.degree} id={items.id} />
            }
            return null
          }
