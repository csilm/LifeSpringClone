    ...
    return (
        <div>
            ...
            <div className='w-full flex flex-row h-auto bg-slate-100 py-4 text-start px-10 text-md font-mono text-slate-600 font-semibold'>
                <a className='hover:text-black mark flex flex-col flex-wrap first-letter mr-2' href='#h'>Home  <div className='line'></div></a> / <div className='hover:text-black mark flex flex-col flex-wrap first-letter mr-2 cursor-pointer px-2'>Professionals <div className='line1'></div></div> / Paediatrics
            </div>
